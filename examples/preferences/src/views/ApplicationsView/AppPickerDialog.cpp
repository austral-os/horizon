...
{
    AppPickerDialog::AppPickerDialog()
        : WaylandWindow("horizon.app_picker", 450, 550, true, true)
    {
    ...
    void AppPickerDialog::setup_ui()
    {
        ...
        root_wnd->set_margin(15);
        root_wnd->set_spacing(10);
        ...
        root_wnd->add_child(std::move(search_box));
        ...
        root_wnd->add_child(std::move(table));
    ...
    void AppPickerDialog::load_apps()
    {
        ...
        // Sort by name
        std::sort(m_all_apps.begin(), m_all_apps.end(), [](const DesktopEntry& a, const DesktopEntry& b) {
