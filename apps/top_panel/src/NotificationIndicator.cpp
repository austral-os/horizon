...
namespace horizon
{
    ...
    void NotificationIndicator::update_state()
    {
        ...
        if (m_enabled)
        {
            m_icon->set_icon_name("notification-symbolic");
        ...
        {
            m_icon->set_icon_name("notification-disabled-symbolic");
    ...
    void NotificationIndicator::toggle_state()
    {
        ...
        // update_state will be called via FileWatcher anyway, but let's do it now for instant
        // feedback
        update_state();
    }
