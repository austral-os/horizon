...
#define ZWLR_LAYER_SHELL_V1_DESTROY_SINCE_VERSION 3
    ...
    zwlr_layer_shell_v1_get_layer_surface(struct zwlr_layer_shell_v1 *zwlr_layer_shell_v1,
                                          ...
                                          uint32_t layer, const char *_namespace)
    {
        struct wl_proxy *id;
        ...
        id = wl_proxy_marshal_flags((struct wl_proxy *)zwlr_layer_shell_v1,
                                    ...
                                    NULL, surface, output, layer, _namespace);
...
#define ZWLR_LAYER_SURFACE_V1_SET_LAYER_SINCE_VERSION 2
    ...
    {
        wl_proxy_marshal_flags(
            (struct wl_proxy *)zwlr_layer_surface_v1, ZWLR_LAYER_SURFACE_V1_SET_EXCLUSIVE_ZONE,
            NULL, wl_proxy_get_version((struct wl_proxy *)zwlr_layer_surface_v1), 0, zone);
    }
    ...
    {
        wl_proxy_marshal_flags((struct wl_proxy *)zwlr_layer_surface_v1,
                               ZWLR_LAYER_SURFACE_V1_DESTROY, NULL,
