#pragma once
#include "horizon/disks/DiskDevice.hpp"
#include <vector>
#include <memory>
#include <functional>
#include <mutex>
...
{
    /**
     * @brief Context for hardware change events.
     */
    struct HardwareChangedContext : public EventContext {};
    ...
    public:
        ...
        /**
         * @brief Checks for hardware changes (disks plugged/unplugged).
         * @return true if changes were detected.
         */
        bool check_hardware_changes();

        /**
         * @brief Signal emitted when hardware changes are detected.
         */
        EventsManager<HardwareChangedContext> when_hardware_changed;
