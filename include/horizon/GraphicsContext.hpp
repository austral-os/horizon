...
namespace horizon
{
    ...
    public:
        ...
        virtual void drawImage(const std::string &path, int x, int y, int w, int h, float alpha = 1.0f) {};
        virtual void drawImage(const std::string &path, int x, int y, int w, int h, Color tint, float alpha = 1.0f) {};
